...
evaluation <- function(k){ 
  ...
  write.csv(df_output, file = paste("probs_five_methods_alpha_40_results/int_probs_five_methods_alpha_",vpro,"_", k,".csv", sep = ""),row.names = FALSE)  ### write the result into .csv file
}
